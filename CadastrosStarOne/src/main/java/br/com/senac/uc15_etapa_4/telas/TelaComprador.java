...
import br.com.senac.uc15_etapa_4.persistencia.Comprador;
import br.com.senac.uc15_etapa_4.persistencia.CompradorJPA;
...
public class TelaComprador extends javax.swing.JFrame {
    ...
    public TelaComprador(Usuario u) {
        initComponents();
    ...
    private DefaultTableModel montarTabela(List<Comprador> listaComprador) {
        String[] colunas = {"ID", "Nome"};
        DefaultTableModel tabela = new DefaultTableModel();
        tabela.setColumnIdentifiers(colunas);

        for (int i = 0; listaComprador.size() > i; i++) {
            Comprador comprador = listaComprador.get(i);

            String[] linha = {
                Integer.toString(comprador.getId()),
                comprador.getNome()
            };
            tabela.addRow(linha);
        }
    ...
    private String getIdItemSelecionado() {
        int posicao = jtableComprador.getSelectedRow();
        if (posicao == -1) {
            JOptionPane.showMessageDialog(null, "Selecione um item da tabela!");
        }
        return (String) jtableComprador.getValueAt(posicao, 0);
    }

    private Comprador compradorEdicao = null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Comprador", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        jtableComprador.setModel(montarTabela(CompradorJPA.listar()));
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        compradorEdicao = CompradorJPA.obter(Integer.parseInt(idSelecionado));
        jTextFieldNome.setText(compradorEdicao.getNome());
    }//GEN-LAST:event_jButtonEditarActionPerformed

    private void jButtonGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGravarActionPerformed
        // TODO add your handling code here:
        Comprador comprador = new Comprador();
        comprador.setNome(jTextFieldNome.getText());

        if (compradorEdicao != null) {
            compradorEdicao.setNome(jTextFieldNome.getText());
            CompradorJPA.atualizar(compradorEdicao);
            JOptionPane.showMessageDialog(null, "Comprador atualizado com sucesso!");

        } else {
            CompradorJPA.cadastrar(comprador);
        ...
        compradorEdicao = null;
    }//GEN-LAST:event_jButtonGravarActionPerformed

    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        // TODO add your handling code here:
        CompradorJPA.excluir(Integer.parseInt(getIdItemSelecionado()));
        jtableComprador.setModel(montarTabela(CompradorJPA.listar()));
        jScrollPane2.setViewportView(jtableComprador);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaComprador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaComprador().setVisible(true);
            }
        });
    }
