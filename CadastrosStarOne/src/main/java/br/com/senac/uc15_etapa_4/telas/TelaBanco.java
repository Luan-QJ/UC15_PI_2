...
import br.com.senac.uc15_etapa_4.persistencia.Banco;
import br.com.senac.uc15_etapa_4.persistencia.BancoJPA;
...
public class TelaBanco extends javax.swing.JFrame {
    ...
    private DefaultTableModel montarTabela(List<Banco> listaBanco) {
        String[] colunas = {"ID", "Banco"};
        DefaultTableModel tabela = new DefaultTableModel();
        tabela.setColumnIdentifiers(colunas);

        for (int i = 0; listaBanco.size() > i; i++) {
            Banco banco = listaBanco.get(i);

            String[] linha = {
                Integer.toString(banco.getId()),
                banco.getBanco()
            };
            tabela.addRow(linha);
        }
    ...
    private String getIdItemSelecionado() {
        int posicao = jtableBanco.getSelectedRow();
        if (posicao == -1) {
            JOptionPane.showMessageDialog(null, "Selecione um item da tabela!");
        }
        return (String) jtableBanco.getValueAt(posicao, 0);
    }

    private Banco bancoEdicao = null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Banco", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        jTextFieldBanco.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldBanco.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextFieldBanco.setForeground(new java.awt.Color(51, 51, 51));
        jTextFieldBanco.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextFieldBanco, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonExcluir)
        ...
        jtableBanco.setModel(montarTabela(BancoJPA.listar()));
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        bancoEdicao = BancoJPA.obter(Integer.parseInt(idSelecionado));
        jTextFieldBanco.setText(bancoEdicao.getBanco());
    }//GEN-LAST:event_jButtonEditarActionPerformed

    private void jButtonGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGravarActionPerformed
        // TODO add your handling code here:
        Banco banco = new Banco();
        banco.setBanco(jTextFieldBanco.getText());

        if (bancoEdicao != null) {
            bancoEdicao.setBanco(jTextFieldBanco.getText());
            BancoJPA.atualizar(bancoEdicao);
            JOptionPane.showMessageDialog(null, "Banco atualizado com sucesso!");

        } else {
            BancoJPA.cadastrar(banco);
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        // TODO add your handling code here:
        BancoJPA.excluir(Integer.parseInt(getIdItemSelecionado()));
        jtableBanco.setModel(montarTabela(BancoJPA.listar()));
        jScrollPane2.setViewportView(jtableBanco);
